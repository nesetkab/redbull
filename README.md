![red bull tracker - to track how unhealthy i am](static/rbtracker.png)

## What?
This is an online web app that keeps track of my Red Bull intake. Other methods are too annoying, and not as funny.
...
## How?
I use Svelte for the front-end, Typescript for the back end, and PostgreSQL for data storage. I use (blank) for hosting.
